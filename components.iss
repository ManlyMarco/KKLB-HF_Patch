...
Name: "Feature\GraphicsSettings";              Description: "Graphics Settings v1.2.1 (More settings to make graphics more or less demanding)"     ; Types: full extra
Name: "Feature\LoveMachine";                   Description: "LoveMachine v3.8.1 (Adds support for some computer-controlled sex toys)"              ; Types: extra
; -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
