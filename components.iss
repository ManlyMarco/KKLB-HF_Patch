[Components]
Name: "BepInEx";                               Description: "BepInEx v5.4.23.1 (Plugin framework)"                                                 ; Types: full extra custom bare; Flags: fixed
...
Name: "BepInEx\ConfigurationManager";          Description: "Configuration Manager v18.4 (Can change plugin settings. Press F1 to open, not visible inside HMD)"; Types: full extra custom bare
...
Name: "Feature\LoveMachine";                   Description: "LoveMachine v3.20.0 (Adds support for some computer-controlled sex toys)"             ; Types: extra
; -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Name: "MISC";                                  Description: "{cm:CompMISC}"                                                                        
Name: "MISC\FPS";                              Description: "FPS Counter v3.1 (Useful for performance testing)"                                    ; Types: full extra
Name: "MISC\Trainer";                          Description: "Runtime Unity Editor v5.5.1 (Tool for making arbitrary modifications to the game, press F12 or Pause key)"; Types: full extra
